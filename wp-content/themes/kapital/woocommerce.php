...
<?php
    ...
    $nz_rh_height           = (isset($nz_ninzio['shop-rh-height']) && $nz_ninzio['shop-rh-height']) ? esc_attr($nz_ninzio["shop-rh-height"]) : "115";
    ...
    $nz_back_img_position   = (isset($nz_ninzio['shop-back']['background-position']) && $nz_ninzio['shop-back']['background-position']) ? $nz_ninzio['shop-back']['background-position'] : "left top";
