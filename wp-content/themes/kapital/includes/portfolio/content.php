		...
		<div class="project-details">
			<?php if ( '' != get_the_title() ){ ?>
				<a href="<?php echo get_permalink(); ?>">
					<h5 class="project-title"><?php echo get_the_title() ?></h5>
				</a>
			<?php } ?>
		...
		<div class="nz-clearfix">
			...
			<div class="single-details sidebar">
				...
				<?php if ($nz_ninzio['port-ss'] && $nz_ninzio['port-ss'] == 1): ?>
					<div class="post-social-share port-v social-links nz-clearfix left">
					    <a class="post-facebook-share icon-facebook5" target="_blank" href="http://www.facebook.com/sharer.php?u=<?php the_permalink();?>&amp;t=<?php the_title(); ?>"><span class="bubble"><?php echo __("Share on Facebook", TEMPNAME); ?></span></a>
						<a class="post-twitter-share icon-twitter4" target="_blank" href="http://twitter.com/home/?status=<?php the_title(); ?> - <?php the_permalink(); ?>"><span class="bubble"><?php echo __("Tweet this!", TEMPNAME); ?></span></a>
					    <a class="post-linkedin-share icon-linkedin" target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&amp;title=<?php the_title(); ?>&amp;url=<?php the_permalink(); ?>"><span class="bubble"><?php echo __("Share on LinkedIn", TEMPNAME); ?></span></a>
					    <a class="post-google-share icon-googleplus6" target="_blank" href="https://plus.google.com/share?url=<?php the_permalink(); ?>" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><span class="bubble"><?php echo __("Share on Google+", TEMPNAME); ?></span></a>
					    <a class="post-pinterest-share icon-pinterest" target="_blank" href="http://pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>&media=<?php $url = wp_get_attachment_url( get_post_thumbnail_id($post->ID) ); echo $url; ?>"><span class="bubble"><?php echo __("Share on Pinterest", TEMPNAME); ?></span></a>
					</div>
				<?php endif; ?>
