...
function render_ninzio_post_title_options($post) {
    ...
    $nz_rh_height           = (isset($nz_ninzio['blog-rh-height']) && !empty($nz_ninzio['blog-rh-height'])) ? $nz_ninzio["blog-rh-height"] : "115";
    $nz_back_color          = (isset($nz_ninzio['blog-back']['background-color']) && !empty($nz_ninzio['blog-back']['background-color'])) ? $nz_ninzio["blog-back"]['background-color'] : "";
    $nz_back_img            = (isset($nz_ninzio['blog-back']['background-image']) && !empty($nz_ninzio['blog-back']['background-image'])) ? $nz_ninzio['blog-back']['background-image'] : "";
    $nz_back_img_repeat     = (isset($nz_ninzio['blog-back']['background-repeat']) && !empty($nz_ninzio['blog-back']['background-repeat'])) ? $nz_ninzio['blog-back']['background-repeat'] : "no-repeat";
    $nz_back_img_position   = (isset($nz_ninzio['blog-back']['background-position']) && !empty($nz_ninzio['blog-back']['background-position'])) ? $nz_ninzio['blog-back']['background-position'] : "left top";
    $nz_back_img_attachment = (isset($nz_ninzio['blog-back']['background-attachment']) && !empty($nz_ninzio['blog-back']['background-attachment'])) ? $nz_ninzio['blog-back']['background-attachment'] : "scroll";
    $nz_back_img_size       = (isset($nz_ninzio['blog-back']['background-size']) && !empty($nz_ninzio['blog-back']['background-size'])) ? $nz_ninzio['blog-back']['background-size'] : "auto";
