...
/*====================================================================*/
	...
	$nz_breadcrumbs_back  = (isset($nz_ninzio['breadcrumbs-back']['color']) && !empty($nz_ninzio['breadcrumbs-back']['color'])) ? ninzio_hex_to_rgba($nz_ninzio['breadcrumbs-back']['color'], $nz_ninzio['breadcrumbs-back']['alpha']) : "";
	$nz_breadcrumbs_color = (isset($nz_ninzio['breadcrumbs-color']) && !empty($nz_ninzio['breadcrumbs-color'])) ? $nz_ninzio['breadcrumbs-color'] : "#ffffff";
...
/*====================================================================*/
	...
	<?php if(!empty($nz_breadcrumbs_back)): ?>
		.rich-header .nz-breadcrumbs {
			padding: 3px 10px;
			background-color: <?php echo $nz_breadcrumbs_back; ?>;
		}
	<?php endif; ?>

	.rich-header .nz-breadcrumbs a,
	.rich-header .nz-breadcrumbs {
		color: <?php echo $nz_breadcrumbs_color; ?>;
	}

	#ninzio-slider .controls {
		border:2px solid  <?php echo $nz_slider_cc; ?>;
		color: <?php echo $nz_slider_cc; ?>;
	}

	#ninzio-slider .controls:hover {
		border:2px solid  <?php echo $nz_slider_cc_hover; ?>;
		color: <?php echo $nz_slider_cc_hover; ?>;
	}
...
/*====================================================================*/
	...
	.woocommerce-tabs .tabs > li.active  {
		border-top-color:<?php echo $nz_color; ?> !important;
		color: <?php echo $nz_headings_color; ?>;
	}
	...
	.woocommerce-pagination li span.current {
		background-color: <?php echo $nz_color; ?>;
		box-shadow: inset 0 0 0 1px <?php echo $nz_color; ?>;
	}
...
/*====================================================================*/
	...
	.main-widget-area 
	{background-color: <?php echo ninzio_hex_to_rgba($nz_sidebar_back,0.98); ?>;}
	...
	.main-widget-area .widget_product_tag_cloud .tagcloud a:hover {
		color: <?php echo $nz_sidebar_hover; ?> !important;
		background-color:<?php echo ninzio_hex_to_rgba($nz_sidebar_color, 0.3); ?>;
	}
	...
	{color: <?php echo ninzio_hex_to_rgba($nz_footer_color,0.5); ?> !important;}
	...
	.footer .social-links a {box-shadow:inset 0 0 0 2px <?php echo ninzio_hex_to_rgba($nz_footer_color,0.2); ?>;}
	.footer .social-links a:hover {box-shadow:inset 0 0 0 40px <?php echo $nz_footer_color_hover; ?>;}
	...
	.footer-widget-area .widget_product_tag_cloud .tagcloud a:hover {
		color: <?php echo $nz_footer_wa_hover; ?> !important;
		background-color:<?php echo ninzio_hex_to_rgba($nz_footer_wa_color, 0.3); ?>;
	}
...
/*====================================================================*/
	...
	@media only screen and (min-width:1025px)  {
		...
		===========*/
			...
			.desk .search form {border-color:<?php echo $nz_desk_submenu_border_col; ?>;}

			.desk .search input[type="text"] {border-color: <?php echo $nz_desk_submenu_border_col; ?>;}
			.desk .search input[type="text"]:focus {background-color: <?php echo ninzio_hex_to_rgba($nz_desk_submenu_color_reg, 0.05); ?>;}
			.desk .search span:before,.desk .search input[type="text"] {color:<?php echo $nz_desk_submenu_color_reg; ?>;}
		...
		===========*/
			...
			.stuck-true .search form {border-color:<?php echo $nz_stuck_submenu_border_col; ?>;}

			.stuck-true .search input[type="text"] {border-color: <?php echo $nz_stuck_submenu_border_col; ?>;}
			.stuck-true .search input[type="text"]:focus {background-color: <?php echo ninzio_hex_to_rgba($nz_stuck_submenu_color_reg, 0.05); ?>;}
			.stuck-true .search span:before,.stuck-true .search input[type="text"] {color:<?php echo $nz_stuck_submenu_color_reg; ?>;}
		...
		===========*/
			...
			.fixed .search form {border-color:<?php echo $nz_fixed_submenu_border_col; ?>;}

			.fixed .search input[type="text"] {border-color: <?php echo $nz_fixed_submenu_border_col; ?>;}
			.fixed .search input[type="text"]:focus {background-color: <?php echo ninzio_hex_to_rgba($nz_fixed_submenu_color_reg, 0.05); ?>;}
			.fixed .search span:before,.fixed .search input[type="text"] {color:<?php echo $nz_fixed_submenu_color_reg; ?>;}
