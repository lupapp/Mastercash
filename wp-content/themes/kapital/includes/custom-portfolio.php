<?php
	...
	function ninzio_portfolio() {
		...
		global $nz_ninzio;
		$portfolio_slug          = (isset($nz_ninzio['port-slug']) && !empty($nz_ninzio['port-slug'])) ? esc_attr($nz_ninzio['port-slug']) : 'portfolio';
	...
	function portfolio_taxonomies() {
		...
		global $nz_ninzio;
		$portfolio_category_slug = (isset($nz_ninzio['port-cat-slug']) && !empty($nz_ninzio['port-cat-slug'])) ? esc_attr($nz_ninzio['port-cat-slug']) : 'portfolio-category';
		$portfolio_tag_slug      = (isset($nz_ninzio['port-tag-slug']) && !empty($nz_ninzio['port-tag-slug'])) ? esc_attr($nz_ninzio['port-tag-slug']) : 'portfolio-tag';
...
<?php
	...
	function render_ninzio_portfolio_title_options($post) {
	    ...
	    $nz_rh_height           = ($nz_ninzio['port-rh-height']) ? $nz_ninzio["port-rh-height"] : "115";
        ...
        $nz_back_img_position   = ($nz_ninzio['port-back']['background-position']) ? $nz_ninzio['port-back']['background-position'] : "left top";
